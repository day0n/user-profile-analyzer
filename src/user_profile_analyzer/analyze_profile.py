...
以下是用户运行最多的工作流，请仔细分析每个工作流的节点组合和输入内容，判断用户使用该工作流的目的。
...
## 分析要求
1. **分析每个工作流的目的**：根据节点组合和输入内容，判断这个工作流是用于：
   - 电商带货（产品展示、商品视频）
   - 广告营销（品牌推广、广告素材）
   - 社交媒体内容（短视频、图文）
   - 个人创作（艺术创作、娱乐）
...
{{
  ...
  "user_profile": {{
    "user_category": "【必须从以下5个选项中选择1个】电商用户 | 营销用户 | 内容创作者 | 个人玩家 | 探索用户",
...
## 用户大类（user_category）判断标准
**重要：只能选择以下5个分类中的1个，不能组合，不能自创分类！**
- **电商用户**：主要用于电商带货、商品展示、产品图片/视频制作
- **营销用户**：主要用于广告营销、品牌推广、商业广告制作
- **内容创作者**：主要用于社交媒体内容、自媒体、短视频创作
- **个人玩家**：主要用于个人创作、艺术创作、娱乐目的
- **探索用户**：主要在探索学习 AI 功能、测试平台能力

**分类优先级（当用户同时符合多个特征时）**：电商用户 > 营销用户 > 内容创作者 > 个人玩家 > 探索用户
